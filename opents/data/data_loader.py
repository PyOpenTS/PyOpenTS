...
class data_loader():
    ...
    def load_ucr(self):
        ...
        train_file_path = os.path.join("UCR", self.dataset_name, self.dataset_name + "_TRAIN.tsv")
        test_file_path = os.path.join("UCR", self.dataset_name, self.dataset_name + "_TEST.tsv")
