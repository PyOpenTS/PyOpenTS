.. PyOpenTS documentation master file, created by
   sphinx-quickstart on Tue Jul 11 08:53:37 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to PyOpenTS's documentation!
====================================
...
test autodoc2
=====================
.. automodule:: opents.datasets.UCRDataset
   :members: